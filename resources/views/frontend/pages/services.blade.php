    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="text-left">
                    <h1
                        class="text-2xl tracking-tight font-bold text-gray-900 sm:text-5xl sm:tracking-tight md:text-6xl md:tracking-tight">
                        <span class="block xl:inline">Services</span>
                    </h1>
                    <div class="mt-12 mb-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-6">
                        ...
                        <div class="group relative">
                            <p class="mt-3 text-base text-gray-500 sm:mt-5 text-2xl">
